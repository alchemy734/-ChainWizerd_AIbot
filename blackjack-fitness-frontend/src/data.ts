...
export const profile: UserProfile = { name: 'Athlete', age: 24, heightCm: 175, weightKg: 72, goal: 'strength', level: 'intermediate' };
export const metrics: DailyMetrics = { steps: 6842, stepGoal: 10000, calories: 412, heartRate: 72, workoutMinutes: 28 };
export const workouts: Workout[] = [
  ...
  { id: 'mobility', title: 'Mobility Reset', category: 'Recovery', durationMinutes: 12, level: 'beginner', calories: 70, description: 'Reset after a long day with gentle mobility and recovery work.', exercises: ['Cat-cow', 'Hip opener', 'World’s greatest stretch', 'Child’s pose'] },
